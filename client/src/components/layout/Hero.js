        ...
        <div className="md:max-w-[350px] lg:max-w-[490px] xl:max-w-[490px]">
          <div className="rating flex justify-center pb-5">
            <div className="bg-[#fff9ef] items-center gap-1 inline-flex px-[15px] py-2 rounded-full">
              ...
              <h4 className="text-sm font-medium">25,430+ 5-Star Reviews</h4>
            </div>
          </div>
          <div className="hero-desc text-center">
            <h1 className="text-4xl font-semibold pb-3">Hello,How Are You?</h1>
            <p className="text-xl">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, labore.</p>
          </div>
          <div className="hidden md:flex lg:flex xl:flex justify-center mt-5 md:pb-5">
            <button
              className="text-white text-lg lg:w-[320px] xl:w-[320px] font-semibold bg-red-color w-full py-4 rounded-md hover:bg-[#910811] hover:transition-all">SHOP
              BEST SELLERS</button>
          </div>
        </div>
